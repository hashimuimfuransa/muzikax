                  ...
                  <button
                    onClick={() => {
                      if (currentTrack.type === 'beat') {
                        // For beats, show a more detailed modal or alert
...
Would you like to open WhatsApp to contact the creator?`;
                          if (confirm(message)) {
                            ...
                            window.open(`https://wa.me/${currentTrack.creatorWhatsapp}?text=${encodeURIComponent(whatsappMessage)}`, '_blank');
                          }
                        } else {
                  ...
                  >
                    ...
                    <span>{currentTrack.type === 'beat' ? 'WhatsApp' : 'Download'}</span>
                  </button>
