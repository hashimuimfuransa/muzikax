        ...
        <div className="max-w-4xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {tracks.map((track) => (
                <div key={track.id} className="card-bg rounded-2xl p-4 sm:p-5 flex items-center gap-4 transition-all hover:border-[#FF8C00]/50 hover:bg-gradient-to-br hover:from-gray-900/70 hover:to-gray-900/50">
