...
export default function Home() {
  ...
  const toggleFavorite = (trackId: string, track: FullTrack) => {
    if (favoriteStatus[trackId]) {
      ...
      addToFavorites({
        ...
        artist: typeof track.creatorId === 'object' && track.creatorId !== null 
          ? (track.creatorId as {_id: string; name: string}).name 
          : 'Unknown Artist',
        coverImage: track.coverURL || '',
        audioUrl: track.audioURL || '',
        creatorId: typeof track.creatorId === 'object' && track.creatorId !== null 
          ? (track.creatorId as {_id: string; name: string})._id 
          : track.creatorId
      });
    }
  };
  ...
  const trendingTracks: Track[] = trendingTracksData.map((track: FullTrack) => ({
    id: track._id,
    title: track.title,
    artist:
    ...
    creatorId: typeof track.creatorId === 'object' && track.creatorId !== null ? (track.creatorId as {_id: string; name: string})._id : track.creatorId
  }));
