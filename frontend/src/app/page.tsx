          ...
          <div className="container mx-auto px-4 md:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-400 mb-4 max-w-md">
                  Connecting Rwandan music creators with fans worldwide. Discover, share, and enjoy the vibrant sounds of Rwanda.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Upload</a></li>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center">
              <p className="text-gray-500 text-sm">
                &copy; {new Date().getFullYear()} MuzikaX. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
