        ...
        <div className="p-6 pt-10">
          ...
          <div className="flex justify-center mb-4">
            <div className="relative">
              <div className="absolute inset-0 bg-[#FF4D67] rounded-full blur-lg animate-pulse"></div>
              <div className="relative bg-[#FF4D67] p-4 rounded-full">
          ...
          {/* Subtitle */}
          <p className="text-[#FF4D67]/80 text-center mb-5 text-xs">
          ...
          <div className="space-y-3 mb-5">
            ...
            <div className="flex items-center space-x-2 text-gray-300 text-sm">
              <span className="text-[#FFCB2B]">🎤</span>
          ...
          {/* Example prompt */}
          <div className="bg-[#FF4D67]/20 rounded-lg p-3 border border-[#FF4D67]/30 mb-5">
            <p className="text-[#FF4D67]/80 text-xs italic text-center">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-gradient-to-r from-[#FF4D67] to-[#FFCB2B] text-white rounded-lg text-sm font-bold hover:shadow-lg hover:shadow-[#FF4D67]/50 transition-all transform hover:scale-105"
            >
              Try Now 🚀
            </button>
          </div>
