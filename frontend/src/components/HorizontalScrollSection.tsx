          ...
          <div className="px-4 md:px-6">
            <div className="flex items-center justify-between mb-3">
              ...
              {viewAllLink && (
                <a
                  href={viewAllLink}
                  className="text-[#FF8C00] hover:text-[#FFB020] text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105"
                >
                  {t('viewAll')}
                </a>
              )}
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            <div className="flex items-center gap-3">
              ...
              {showRecommendedBadge && (
                <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-[#FF8C00] to-[#FFB020] text-white shadow-lg">
            ...
            {viewAllLink && (
              <a
                href={viewAllLink}
                className="text-[#FF8C00] hover:text-[#FFB020] text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105 whitespace-nowrap"
              >
                {t('viewAll')}
              </a>
            )}
