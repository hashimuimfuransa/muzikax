    ...
    <div className="fixed left-6 top-20 z-[99999] transition-all duration-300 translate-x-0 opacity-100">
      <div className="relative">
        ...
        <button
          ...
          className="w-14 h-14 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 rounded-full shadow-2xl flex items-center justify-center text-white hover:shadow-3xl transition-all duration-300 transform hover:scale-105 relative group"
        ...
        {isOpen && (
          <div className="absolute bottom-25 right-0 mb-2 space-y-3 animate-slideUp">
            {/* WhatsApp Option */}
