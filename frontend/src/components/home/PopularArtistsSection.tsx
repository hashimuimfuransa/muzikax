            ...
            <div className="rounded-[14px] glassmorphism-advanced p-3 md:p-4 lg:p-5 backdrop-blur-xl hover:bg-[var(--card-bg)]/70 transition-colors">
              ...
              >
                <div className="relative mb-2 md:mb-3 pulse-ring">
                  ...
                  {creator.verified && (
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-r from-[#FF4D67] to-[#FFCB2B] border-4 border-[var(--card-bg)] flex items-center justify-center neon-glow shadow-lg">
                ...
                <p className="text-[#FFCB2B] text-xs md:text-sm lg:text-base mb-1 md:mb-2 font-semibold gradient-text-animated">
                  {creator.type}
                </p>
                ...
                <button 
                  className="mt-1 md:mt-2 w-full px-2 md:px-3 py-1.5 gradient-primary text-white hover:shadow-lg hover:shadow-[#FF4D67]/40 rounded-full text-xs md:text-sm font-bold transition-all fab-spring border-0 shadow-md"
                  onClick={(e) => {
                    e.stopPropagation();
                    if (!isAuthenticated) {
                      router.push('/login');
