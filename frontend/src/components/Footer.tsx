...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 w-full flex-shrink-0">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 sm:col-span-1 md:col-span-1 lg:col-span-1">
            <Link href="/" className="flex items-center">
              <img src="/muzikax.png" alt="MuzikaX Logo" className="h-7 w-auto sm:h-8" />
              <span className="ml-2 sm:ml-3 text-lg sm:text-xl font-bold text-white">MuzikaX</span>
            </Link>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mt-4 sm:mt-6">
              <div className="flex items-center text-xs sm:text-sm text-gray-400">
                ...
                <a href="tel:+250793828834" className="hover:text-[#FF4D67] transition-colors text-xs sm:text-sm">
                  +250 793 828 834
                </a>
              </div>
          ...
          {/* Product Links */}
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-white uppercase tracking-wider">{t('product')}</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-white uppercase tracking-wider">{t('company')}</h3>
            <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-3">
          ...
          {/* Support Links */}
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-white uppercase tracking-wider">{t('support')}</h3>
            <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-3">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-white uppercase tracking-wider">{t('legal')}</h3>
            <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-3">
        ...
        <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
              <span className="text-gray-400 text-xs sm:text-sm text-center">{t('madeWithIn')}</span>
            </div>
          </div>
        </div>
      </div>
