        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3">
              <a href="tel:+250793828834" className="flex items-center gap-3 text-gray-300 hover:text-[#FF4D67] transition-colors group">
                <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center group-hover:bg-[#FF4D67]/10 transition-colors">
                ...
                <span className="text-sm font-medium">+250 793 828 834</span>
              </a>
            </div>
          </div>
          ...
          {footerLinks.map((section, idx) => (
            <div key={section.title}>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-4 flex items-center gap-2">
                <span className="w-1 h-5 bg-gradient-to-b from-[#FF4D67] to-[#FFCB2B] rounded-full"></span>
                {section.title}
              </h3>
                ...
                {section.links.map((link) => (
                  <li key={link.name}>
                    {link.href ? (
                      <Link 
                        href={link.href} 
                        className="text-gray-300 hover:text-[#FF4D67] transition-colors text-sm flex items-center gap-2 group"
                      >
