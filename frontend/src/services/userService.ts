 ...
 */
export const addTrackToFavorites = async (trackId: string): Promise<any> => {
  try {
 ...
 */
export const removeTrackFromFavorites = async (trackId: string): Promise<any> => {
  try {
    const response = await makeAuthenticatedRequest(`${process.env.NEXT_PUBLIC_API_URL}/api/favorites`, {
      method: 'DELETE',
      body: JSON.stringify({ trackId })
 ...
 */
export const createPlaylist = async (name: string, description: string = '', isPublic: boolean = true, trackIds: string[] = []): Promise<any> => {
  try {
 ...
 */
export const addTrackToPlaylist = async (playlistId: string, trackId: string): Promise<any> => {
  try {
 ...
 */
export const updatePlaylistMetadata = async (playlistId: string, name?: string, description?: string, isPublic?: boolean): Promise<any> => {
  try {
    const response = await makeAuthenticatedRequest(`${process.env.NEXT_PUBLIC_API_URL}/api/playlists/${playlistId}`, {
      method: 'PATCH',
